...
function hg.DoTPIK(ply, ent)
    ...
    if lerp_rh != 0 then
        ...
        q = q * Quaternion():SetAngleAxis(-135 + angrr.y - eyeang.y, Vector(1, 0, 0))
        ...
        q = q * Quaternion():SetAngleAxis(angrr.y, Vector(0, 0, 1))
        q = q * Quaternion():SetAngleAxis(angrr.p, Vector(0, 1, 0))
        q = q * Quaternion():SetAngleAxis(-135 - angrr.r - math.NormalizeAngle((eyeang.y - angrr.y)) * (math.NormalizeAngle(angrr.p)) / 90, Vector(1, 0, 0))
        --q:SetAngleAxis(-angle2 + 180, Vector(0, 1, 0))
        --q:SetAngleAxis(180, Vector(1, 0, 0))
        local ang = q:Angle()
    ...
    if lerp_lh != 0 then
        ...
        q = q * Quaternion():SetAngleAxis(angrr.y, Vector(0, 0, 1))
        q = q * Quaternion():SetAngleAxis(angrr.p, Vector(0, 1, 0))
        q = q * Quaternion():SetAngleAxis(-30 + angrr.y - eyeang.y, Vector(1, 0, 0))
        --q:SetAngleAxis(-angle2 + 180, Vector(0, 1, 0))
        --q:SetAngleAxis(180, Vector(1, 0, 0))
        local ang = q:Angle()
        ...
        q = q * Quaternion():SetAngleAxis(angrr.y, Vector(0, 0, 1))
        q = q * Quaternion():SetAngleAxis(angrr.p, Vector(0, 1, 0))
        q = q * Quaternion():SetAngleAxis(-30 - angrr.r - math.NormalizeAngle((eyeang.y - angrr.y)) * (math.NormalizeAngle(angrr.p)) / 90, Vector(1, 0, 0))
        --q:SetAngleAxis(-angle2 + 180, Vector(0, 1, 0))
        --q:SetAngleAxis(180, Vector(1, 0, 0))
        local ang = q:Angle()
